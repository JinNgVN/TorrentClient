        ...
        switch (key) {
            ...
            case "files": {
                ...
                for (var file : files) {
                    ...
                    //TODO: just changed the definition of FileInFo, need to change the parameter "path in the below statement"
                    FileInfo fileTorrent = new FileInfo(length, Collections.singletonList(path));
